    ...
    <div class="tsm-col-12">
        <div class="tsm-col-6 tsm-p-0">
            <div class="tsm-container-right">
                ...
                <textarea class="tsm-form-control tsm-mt-1 tsm-textarea" rows="3" name="" id=""></textarea>
            </div>
        </div>
    </div>
                    ...
                    <div class="tsm-container">
                        <table class="tsm-table">
                            <tr class="tsm-first-section">
                                ...
                                <td style="width: 30%;">
                                    <select style="width: 100%;" class="tsm-multiple-select" name="sub_categories"
                                        id="">
                ...
                <div class="tsm-container">
                    <table class="tsm-pricing-table">
                        ...
                        <tr class="tsm-first-section">
                            ...
                            <td style="width: 15%;">
                                <input class="tsm-dynamic-input tsm-form-control" step="0.1" type="number"
                                    placeholder="3.75">
                            </td>
                            <td style="width: 10%;"><a class="tsm-tr-delete-button">Delete</a></td>
                            <td style="width: 15%;">
