...
<form class="tsm-admin-settings-form" method="POST">
  ...
  <div class="input-wrapper checkbox">
    ...
    <input
      ...
      <?php tps_manager_is_checked( $data[ FreeShippingSettings::HIDE_OTHERS ] ); ?>
    >
  ...
  <div class="input-wrapper checkbox">
    ...
    <input
      ...
      value="<?php echo esc_attr( Constants::YES ); ?>"
		  <?php tps_manager_is_checked( $data[ FreeShippingSettings::FREE_SHIPPING_BAR ] ); ?>
    >
  ...
  <div class="input-wrapper checkbox">
    ...
    <input
      ...
      value="<?php echo esc_attr( Constants::YES ); ?>"
  		<?php tps_manager_is_checked( $data[ FreeShippingSettings::MINIMUM_AMOUNT ] ); ?>
    >
  ...
  <div class="input-wrapper checkbox">
    ...
    <input
      ...
      value="<?php echo esc_attr( Constants::YES ); ?>"
  		<?php tps_manager_is_checked( $data[ FreeShippingSettings::AFTER_COUPON ] ); ?>
    >
